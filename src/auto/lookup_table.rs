...
mod sealed {
    pub trait Sealed {}
    impl<T: super::IsA<super::LookupTable>> Sealed for T {}
}

pub trait LookupTableExt: IsA<LookupTable> + sealed::Sealed + 'static {
    ...
    #[doc(alias = "ibus_lookup_table_set_orientation")]
    fn set_orientation(&self, orientation: i32) {
        unsafe {
            ffi::ibus_lookup_table_set_orientation(self.as_ref().to_glib_none().0, orientation);
        }
    }
