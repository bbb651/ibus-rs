...
//pub fn emoji_dict_lookup(dict: /*Unknown conversion*//*Unimplemented*/HashTable TypeId { ns_id: 0, id: 28 }/TypeId { ns_id: 1, id: 35 }, emoji: &str) -> Option<EmojiData> {
...
pub fn free_strv(strv: &str) {
    assert_initialized_main_thread!();
    unsafe {
        ffi::ibus_free_strv(strv.to_glib_none().0);
    }
}
