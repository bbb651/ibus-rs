...
impl StaticType for BusNameFlag {
                #[inline]
    #[doc(alias = "ibus_bus_name_flag_get_type")]
...
unsafe impl<'a> glib::value::FromValue<'a> for BusNameFlag {
...
bitflags! {
    ...
    pub struct Capabilite: u32 {
        ...
        #[doc(alias = "IBUS_CAP_SYNC_PROCESS_KEY_V2")]
        const SYNC_PROCESS_KEY_V2 = ffi::IBUS_CAP_SYNC_PROCESS_KEY_V2 as _;
    }
}
...
impl StaticType for Capabilite {
                #[inline]
    #[doc(alias = "ibus_capabilite_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for Capabilite {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl StaticType for InputHints {
                #[inline]
    #[doc(alias = "ibus_input_hints_get_type")]
   fn static_type() -> glib::Type {
...
impl StaticType for ModifierType {
                #[inline]
    #[doc(alias = "ibus_modifier_type_get_type")]
   fn static_type() -> glib::Type {
...
impl StaticType for ObjectFlags {
                #[inline]
    #[doc(alias = "ibus_object_flags_get_type")]
   fn static_type() -> glib::Type {
