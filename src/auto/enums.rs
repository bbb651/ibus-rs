...
impl StaticType for AttrType {
                #[inline]
    #[doc(alias = "ibus_attr_type_get_type")]
...
impl StaticType for AttrUnderline {
                #[inline]
    #[doc(alias = "ibus_attr_underline_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for AttrUnderline {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
#[derive(Clone, Copy)]
#[non_exhaustive]
#[doc(alias = "IBusBusGlobalBindingType")]
pub enum BusGlobalBindingType {
    #[doc(alias = "IBUS_BUS_GLOBAL_BINDING_TYPE_ANY")]
    Any,
    #[doc(alias = "IBUS_BUS_GLOBAL_BINDING_TYPE_IME_SWITCHER")]
    ImeSwitcher,
    #[doc(alias = "IBUS_BUS_GLOBAL_BINDING_TYPE_EMOJI_TYPING")]
    EmojiTyping,
#[doc(hidden)]
    __Unknown(i32),
}
...
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
#[doc(hidden)]
impl IntoGlib for BusGlobalBindingType {
    type GlibType = ffi::IBusBusGlobalBindingType;

    #[inline]
fn into_glib(self) -> ffi::IBusBusGlobalBindingType {
match self {
            Self::Any => ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_ANY,
            Self::ImeSwitcher => ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_IME_SWITCHER,
            Self::EmojiTyping => ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_EMOJI_TYPING,
            Self::__Unknown(value) => value,
}
}
}
...
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
#[doc(hidden)]
impl FromGlib<ffi::IBusBusGlobalBindingType> for BusGlobalBindingType {
    #[inline]
unsafe fn from_glib(value: ffi::IBusBusGlobalBindingType) -> Self {
        skip_assert_initialized!();
        
match value {
            ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_ANY => Self::Any,
            ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_IME_SWITCHER => Self::ImeSwitcher,
            ffi::IBUS_BUS_GLOBAL_BINDING_TYPE_EMOJI_TYPING => Self::EmojiTyping,
            value => Self::__Unknown(value),
}
}
}
...
#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
impl StaticType for BusGlobalBindingType {
                #[inline]
    #[doc(alias = "ibus_bus_global_binding_type_get_type")]
   fn static_type() -> glib::Type {
                    unsafe { from_glib(ffi::ibus_bus_global_binding_type_get_type()) }
                }
            }

#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
impl glib::HasParamSpec for BusGlobalBindingType {
                type ParamSpec = glib::ParamSpecEnum;
                type SetValue = Self;
                type BuilderFn = fn(&str, Self) -> glib::ParamSpecEnumBuilder<Self>;
...
#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
impl glib::value::ValueType for BusGlobalBindingType {
    type Type = Self;
}

#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
unsafe impl<'a> glib::value::FromValue<'a> for BusGlobalBindingType {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
impl ToValue for BusGlobalBindingType {
    #[inline]
    fn to_value(&self) -> glib::Value {
        let mut value = glib::Value::for_value_type::<Self>();
        unsafe {
...
#[cfg(feature = "v1_5_29")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_29")))]
impl From<BusGlobalBindingType> for glib::Value {
    #[inline]
    fn from(v: BusGlobalBindingType) -> Self {
        skip_assert_initialized!();
        ToValue::to_value(&v)
    }
}
...
impl StaticType for BusRequestNameReply {
                #[inline]
    #[doc(alias = "ibus_bus_request_name_reply_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for BusRequestNameReply {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl StaticType for BusStartServiceByNameReply {
                #[inline]
    #[doc(alias = "ibus_bus_start_service_by_name_reply_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for BusStartServiceByNameReply {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
#[cfg(feature = "v1_5_4")]
#[cfg_attr(docsrs, doc(cfg(feature = "v1_5_4")))]
#[derive(Debug, Eq, PartialEq, Ord, PartialOrd, Hash)]
#[derive(Clone, Copy)]
#[non_exhaustive]
...
impl StaticType for InputPurpose {
                #[inline]
    #[doc(alias = "ibus_input_purpose_get_type")]
   fn static_type() -> glib::Type {
...
impl StaticType for Orientation {
                #[inline]
    #[doc(alias = "ibus_orientation_get_type")]
   fn static_type() -> glib::Type {
...
impl StaticType for PreeditFocusMode {
                #[inline]
    #[doc(alias = "ibus_preedit_focus_mode_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for PreeditFocusMode {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl StaticType for PropState {
                #[inline]
    #[doc(alias = "ibus_prop_state_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for PropState {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl StaticType for PropType {
                #[inline]
    #[doc(alias = "ibus_prop_type_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for PropType {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
...
impl StaticType for XEventType {
                #[inline]
    #[doc(alias = "ibus_xevent_type_get_type")]
   fn static_type() -> glib::Type {
...
unsafe impl<'a> glib::value::FromValue<'a> for XEventType {
    type Checker = glib::value::GenericValueTypeChecker<Self>;
